...
$db_conn->do("update video set seed_popularity = 0 where channel = $channel");
#$db_conn->do("update video set seed_popularity = 0 where 1 = 1");
my $request = $db_conn->prepare("select sn, fav_count from video where 1 = 0 or channel = $channel");
$request->execute;
